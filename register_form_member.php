...
include 'config.php';
 ...
 if(isset($_POST['submit'])) {
   ...
   $sql=" INSERT INTO `member_table`( `name`, `contact_no`, `gender`, `email`, `password`) VALUES ('$name','$contact_no','$gender','$email','$password')";
  $result=mysqli_query($conn,$sql);
 if($result){
    echo "<script>alert('Member registration successfull')</script>";
    $name="";
    $contact_no="";
    $gender="";
    $email="";
...
<body>
    ...
    <form action="" method="post">
        ...
        <input type="password" name="cpassword" required placeholder="enter your password">
            ...
            <p>already have an account? <a href="member_login_form.php">login now</a></p>
    <form>
</body>
</html>